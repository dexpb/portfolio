      ...
      <div className="grid gap-10 lg:flex lg:justify-center">
        ...
        <div className="group relative overflow-hidden rounded-xl border-2 border-white/50 text-white lg:w-1/3">
          ...
          <a href="https://fsw-barber-sand.vercel.app/">
            <Button
              variant="outline"
              className="absolute text-sm -bottom-full left-12 z-50 h-16 w-24 rounded-3xl font-bold text-white shadow-2xl shadow-emph-dark transition-all duration-700 group-hover:bottom-[50px] lg:h-14 lg:w-36 lg:group-hover:bottom-20"
            >
              Ver Projeto
            </Button>
          </a>
