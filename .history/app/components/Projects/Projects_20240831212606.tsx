      ...
      <div className="grid gap-10 lg:flex lg:justify-center">
        <div className="group relative overflow-hidden rounded-xl border-2 border-white/50 text-white lg:flex lg:w-1/3 lg:flex-row">
          ...
          <div className="absolute -bottom-full left-12 z-50 transition-all duration-500 group-hover:bottom-48">
            ...
            <p>Landing page desenvolvida com <span>React, CSS e Framer Motion</span></p>
          </div>
          <div className="absolute -bottom-full left-12 z-50 transition-all duration-700 group-hover:bottom-36">
            <h2 className="text-2xl">Jeff Design</h2>
          </div>
          <a href="https://jeffdesign.vercel.app/">
            <Button
              variant="outline"
              className="absolute -bottom-full left-12 z-50 h-16 w-20 rounded-3xl font-bold text-white shadow-2xl shadow-emph-dark transition-all duration-700 group-hover:bottom-[50px] lg:h-14 lg:w-36 lg:group-hover:bottom-20"
            >
              Ver Projeto
            </Button>
          </a>
        ...
        <div className="group relative overflow-hidden rounded-xl border-2 border-white/50 text-white lg:w-1/3">
          ...
          <div className="absolute -bottom-full left-12 z-50 transition-all duration-500 group-hover:bottom-48">
            <h2 className="text-3xl font-bold">Front-end</h2>
            <p>Projeto da Full Stack Week, utilizando NextJS, TypeScript, Shadcn e Prisma. </p>
          </div>
          <div className="absolute -bottom-full left-12 z-50 transition-all duration-700 group-hover:bottom-36">
          ...
          <a href="https://fsw-barber-sand.vercel.app/">
            <Button
              variant="outline"
              className="absolute -bottom-full left-12 z-50 h-16 w-24 rounded-3xl font-bold text-white shadow-2xl shadow-emph-dark transition-all duration-700 group-hover:bottom-[50px] lg:h-14 lg:w-36 lg:group-hover:bottom-20"
            >
              Ver Projeto
            </Button>
          </a>

          <div className="absolute -bottom-full lg:left-64 z-50 transition-all duration-700 group-hover:bottom-[60px] lg:left-52 lg:group-hover:bottom-[84px]">
