...
export default function Projects() {
  return (
    <div className="flex flex-col items-center justify-center gap-10 space-y-40 font-josefin text-5xl font-bold text-emph-dark dark:text-white lg:w-screen lg:text-6xl">
      <ul>
        <Skills />
      </ul>
      ...
      >
        ...
        <div className="lg:flex lg:justify-center lg:gap-10">
          <div className="group relative overflow-hidden rounded-xl border-2 border-white/50 text-white lg:flex lg:w-1/3 lg:flex-row">
            ...
            <div className="absolute -bottom-full left-64 z-50 transition-all duration-700 group-hover:bottom-[60px] lg:left-52 lg:group-hover:bottom-20">
