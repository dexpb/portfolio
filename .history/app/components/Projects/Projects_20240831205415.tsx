  ...
  return (
    <div>
      <motion.div
        ...
        id="projetos"
        className="m-10 lg:m-20 flex h-screen flex-1 flex-col gap-20"
      >
        <h2 className="text-center text-4xl lg:text-7xl text-emph-dark dark:text-white uppercase font-bold">Projetos</h2>
        {/* projects image */}
