  ...
  return (
    <div className="flex flex-col space-y-40 items-center justify-center gap-10 font-josefin text-5xl font-bold text-emph-dark dark:text-white lg:w-screen lg:text-6xl">
      ...
      >
        ...
        {/* projects image */}
        <div className="group relative overflow-hidden rounded-xl border-2 border-white/50 text-white lg:w-1/3 lg:flex lg:flex-row lg:items-center lg:justify-center">
