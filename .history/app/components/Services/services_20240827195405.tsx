...
export function Services() {
  return (
    <div className="flex flex-col gap-10 mb-20 items-center">
      ...
      <div className="flex flex-col justify-center lg:flex-row h-[300px] w-full items-center gap-10 bg-gradient-to-b from-emph-dark to-emph-darker p-10 shadow-2xl shadow-emph-darker">
        <div className="">
          <AppWindow size={50} />
