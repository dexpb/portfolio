...
export function Services() {
  return (
    <div className="justify-cente flex flex-col items-center">
      ...
      <div className="flex flex-col lg:flex-row h-[300px] w-full items-center gap-10 rounded-xl bg-gradient-to-b from-emph-dark to-emph-darker p-10 shadow-2xl shadow-emph-darker">
        <div className="">
          <AppWindow size={50} />
