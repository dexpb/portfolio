...
export function Services() {
  return (
    <div className="justify-cente flex flex-col items-center">
      ...
      <div className="flex items-center shadow-2xl shadow-emph-darker h-[350px] w-3/5 gap-10 rounded-xl bg-gradient-to-b from-emph-dark to-emph-darker p-10">
        <div className="bg-emph-darker blur-lg">
          <AppWindow size={50} />
