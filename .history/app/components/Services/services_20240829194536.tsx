...
export function Services() {
  return (
    <div className="flex flex-col items-center lg:mb-20 lg:gap-10">
      <motion.h1
      ...
      <div className="flex flex-col items-center justify-center lg:flex-row">
        <div className="flex h-[50px] w-[200px] flex-col gap-10 lg:m-20 lg:h-[350px] lg:w-4/6 lg:flex-row">
          <motion.div
          ...
          >
            <AppWindow size={50} />
            <h2 className=" text-sm lg:text-xl font-bold">Desenvolvimento</h2>
