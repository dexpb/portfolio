...
export function Services() {
  return (
    <div className="flex flex-col gap-20 mb-20 items-center">
      <h1 className="text-6xl font-semibold uppercase">Serviços</h1>

      <div className="flex flex-col justify-center lg:flex-row h-[300px] w-full items-center gap-10 bg-emph-dark">
        <div>
          <AppWindow size={50} />
