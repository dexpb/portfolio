...
export function Services() {
  return (
    <div className="justify-cente flex flex-col items-center">
      ...
      <div className="flex items-center justify-center shadow-2xl shadow-emph-darker h-[300px] w-3/6 gap-10 rounded-xl bg-gradient-to-b from-emph-dark to-emph-darker p-10">
        <div className="">
          <AppWindow size={50} />
