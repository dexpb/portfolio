...
export function Services() {
  return (
    <div className="mb-20 flex flex-col items-center gap-10">
      ...
      <div className="flex h-10 lg:h-[350px] w-full flex-col items-center justify-center lg:flex-row">
        <div className="m-20 flex flex-col lg:flex-row  h-[20px] lg:w-4/6 gap-10">
          <motion.div
