...
export default function Introduction() {
  return (
    <div className="mb-10 flex h-2/6 lg:mb-0 lg:ml-0 lg:flex-col lg:items-center lg:justify-center">
      <div className="flex flex-col items-center justify-center gap-20 lg:gap-0 lg:w-screen lg:flex-row lg:justify-between lg:p-10 space-x-10">
        {/* text */}
        <div className="order-2 flex-col items-center justify-center text-center lg:order-none lg:items-start lg:justify-start lg:text-left">
          ...
          >
            <p className="mt-10 text-balance font-josefin text-3xl font-semibold text-dark-mode dark:text-white lg:text-5xl">
          ...
          >
            <div className="m-10 flex flex-row justify-center gap-6 lg:mx-0 lg:justify-start lg:gap-10">
              ...
              <Image
                ...
                width={50}
                alt=""
                className="hidden transition duration-500 ease-in-out hover:scale-125 lg:dark:block"
              />
              <Image
                src={Github}
                width={50}
