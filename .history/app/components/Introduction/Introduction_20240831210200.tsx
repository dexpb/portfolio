...
export default function Introduction() {
  return (
    <div className="mb-10 flex h-2/6 lg:mb-0 lg:ml-0 lg:flex-col lg:items-center lg:justify-center">
      <div className="flex flex-col items-center justify-center  gap-20 lg:gap-0 w-screen lg:flex-row lg:justify-between lg:p-8">
        {/* text */}
        <div className="order-2 flex-col items-center justify-center text-center lg:order-none lg:items-start lg:justify-start lg:text-left">
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.7 }}
          >
            <div className="m-10 flex flex-row justify-center place-items-center gap-6 lg:mx-0 lg:justify-start lg:gap-10">
              <Image
                src={Email}
                width={50}
                alt=""
