...
export default function Introduction() {
  return (
    <div className="mb-10 flex h-2/6 lg:mb-0 lg:ml-0 lg:flex-col lg:items-center lg:justify-center">
      <div className="flex flex-col items-center justify-center gap-20 lg:w-screen lg:flex-row lg:justify-between lg:p-8">
        {/* text */}
          ...
          >
            <div className="m-10 flex flex-row justify-center gap-6 lg:mx-0 lg:justify-start lg:gap-10">
              ...
              <Image
                ...
                width={50}
                alt=""
                className="hidden transition duration-500 ease-in-out hover:scale-125 lg:block"
              />
              <Image
                src={Github}
                width={50}
                alt=""
                className="hidden transition w-14 duration-500 ease-in-out hover:scale-125 dark:block"
              />
              <Image
                src={Linkedin}
                width={50}
