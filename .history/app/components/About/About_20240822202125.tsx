...
export default function About() {
  return (
    ...
    viewport={{ once: true, amount: 0.7 }}
      id="sobre"
      className="mb-20 flex h-full w-screen items-center justify-center font-josefin text-white dark:text-emph-dark"
    >
      <div       className="ml-20 hidden bg-dark-mode dark:bg-white w-[480px] lg:flex h-[750px] rounded-[80px]">
        <div className="m-auto flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col items-center text-center justify-center gap-4 text-break text-lg text-zinc-200 dark:text-zinc-600">
            <p>
              Amante de jogos competitivos como: Call of Duty, League of Legends
              e Counter-strike. 
              Também curto filmes da Marvel. Filme preferido? Vingadores: Ultimato
            </p>
            <p>
      ...
      <div className="m-36 flex w-full flex-col items-center lg:w-3/5 lg:items-start lg:justify-start">
        ...
        <p className="text-center text-2xl text-text-dark dark:text-white lg:ml-10 lg:text-wrap lg:text-left lg:text-[50px] lg:leading-[50px]">
