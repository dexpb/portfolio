...
export default function About() {
  return (
    <motion.div
      ...
      id="sobre"
      className="mb-40 lg:mb-20 flex h-full w-screen items-center justify-center font-josefin text-white dark:text-emph-dark"
    >
      <div className="ml-20 hidden h-[750px] w-[480px] rounded-[80px] bg-dark-mode dark:bg-white lg:flex">
