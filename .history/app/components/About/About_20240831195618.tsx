  ...
  return (
    ...
    >
      <div className="ml-20 hidden h-[750px] w-[380px] rounded-[80px] bg-dark-mode dark:bg-white lg:flex">
        <div className="m-auto flex flex-col items-center gap-6">
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-balance text-center text-[250px] font-semibold leading-8 text-zinc-400">
      ...
      <div className="m-36 flex w-full flex-col items-center lg:w-3/5 lg:items-start lg:justify-start">
        <h1 className="text-center text-7xl uppercase font-bold text-text-dark dark:text-white lg:justify-start lg:text-left lg:text-7xl">
          Sobre
        </h1>
