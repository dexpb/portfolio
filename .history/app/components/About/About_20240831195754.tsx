    ...
    >
      <div className="ml-20 hidden h-[750px] w-[380px] rounded-[80px] bg-dark-mode dark:bg-white lg:flex">
        <div className="m-auto flex flex-col items-center gap-6">
          ...
          <div className="text-break flex flex-col items-center justify-center gap-8 text-center text-lg text-zinc-200 dark:text-zinc-600">
            <p>
      ...
      <div className="m-36 flex w-full flex-col items-center lg:w-3/5 lg:items-start lg:justify-start">
        ...
        <p className="text-center text-2xl text-text-dark dark:text-white lg:ml-10 lg:text-wrap lg:text-left lg:text-[30px] lg:leading-[50px]">
