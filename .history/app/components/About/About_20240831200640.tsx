...
export default function About() {
  return (
    ...
    >
      ...
      <div className="mx-4 hidden flex-col gap-10 lg:flex">
        <Image
          src={Email}
          width={50}
          alt=""
      ...
      <div className=" flex w-full flex-col items-center lg:w-3/5 lg:items-start lg:justify-start">
        <h1 className="text-center uppercase text-6xl font-bold text-text-dark dark:text-white lg:justify-start lg:text-left lg:text-7xl">
          Sobre
        </h1>
        <p className="text-center text-lg text-text-dark dark:text-white lg:ml-10 text-wrap lg:text-left lg:text-[30px] lg:leading-[50px]">
