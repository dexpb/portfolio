...
export default function Footer() {
  ...
  const sendEmail = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const templateParams = {
      ...
      message:
        "Olá! Venho diretamente do seu portfólio, gostaria de conversar contigo um pouco mais sobre você",
    };
  ...
  return (
    <div className="flex h-[420px] flex-col items-center justify-center gap-5 font-josefin font-bold bg-emph-darker">
      <h1 className="text-4xl dark:text-emph-dark text-white lg:text-5xl">
          ...
          <div className="flex h-full w-14 cursor-pointer items-center  justify-center border-none bg-emph-light dark:bg-emph-dark">
            <button type="submit" className="">
              <svg
                ...
                viewBox="0 0 16 16"
                fill="currentColor"
                className="h-8 w-10 opacity-100 active:bg-emph-darker transition-all "
              >
