...
export default function Footer() {
  ...
  return (
    <div id="contato" className="flex p-10 h-[420px] flex-col items-center justify-center gap-5 bg-emph-darker font-josefin font-bold">
      ...
      <form onSubmit={sendEmail} className="flex w-full justify-center">
        <label className="input input-bordered flex items-center rounded-none border-none bg-dark-mode p-0 pl-2 text-white dark:bg-white dark:text-black lg:w-2/6">
          <input
            type="email"
            className="grow"
          ...
          <div className="flex h-full w-14 cursor-pointer items-center justify-center border-none bg-emph-light dark:bg-emph-dark">
            <button type="submit">
              <svg
                ...
                viewBox="0 0 16 16"
                fill="currentColor"
                className="h-8 w-10 opacity-100 transition-all"
              >
