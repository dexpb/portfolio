...
export default function Footer() {
  ...
  return (
    <div className="flex h-[420px] flex-col items-center justify-center gap-5 bg-emph-darker font-josefin font-bold">
      ...
      <form onSubmit={sendEmail} className="flex w-full justify-center">
        <label className="input input-bordered flex w-3/4 items-center rounded-none border-none bg-dark-mode p-0 pl-2 text-white dark:bg-white dark:text-black lg:w-2/6">
          <input
            ...
            required
          />
          <div className="flex h-full cursor-pointer items-center justify-center border-none bg-emph-light dark:bg-emph-dark">
