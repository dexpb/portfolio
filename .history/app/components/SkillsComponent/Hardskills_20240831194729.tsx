...
export default function Hardskills() {
  return (
    <div className="flex flex-col items-center justify-center gap-20 font-josefin text-5xl font-bold text-emph-dark dark:text-white lg:w-screen lg:text-6xl">
      <motion.h2 className="uppercase text-7xl"
